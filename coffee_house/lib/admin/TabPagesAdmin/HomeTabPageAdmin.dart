                      ...
                      child: TextButton(
                        ...
                        onPressed: name.isEmpty
                          ...
                          Navigator.pushNamedAndRemoveUntil(
                              context, LoginAdminScreen.idScreen, (route) => false);
                        }
                            : null,
                                  ...
                                  builder: (BuildContext context, Widget? child) {
                                    return Stack(
                                      children: [
                                        ...
                                        Positioned(
                                          left: (1 - _slideAnimation!.value) * MediaQuery.of(context).size.width + 30,
                                          child: Container(
                                            color: Colors.grey,
                                            width: 0,
                                            height: 200.0,
                                        ...
                                        Positioned(
                                          left: (1 - _slideAnimation!.value) * MediaQuery.of(context).size.width + 0 + 30,
                                          child: Image(
