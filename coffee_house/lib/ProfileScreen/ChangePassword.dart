// ignore_for_file: use_key_in_widget_constructors, prefer_const_constructors, deprecated_member_use, must_be_immutable, file_names, library_private_types_in_public_api, unused_field, prefer_final_fields, unrelated_type_equality_checks, non_constant_identifier_names
                ...
                children: [
                  ElevatedButton(
                    onPressed: () {
                      ...
                      String textValueNew = confirmpasswordTextEdittingController.text;
                      if(textValue != userInformation!.password.toString() || oldPasswordTextEdittingController.text.isEmpty){
                        displayToastMessage("Lỗi mật khẩu cũ", context);
                      }else if(textValueOld != textValueNew ||
                          passwordTextEdittingController.text.isEmpty || confirmpasswordTextEdittingController.text.isEmpty){
                        displayToastMessage("Lỗi mật khẩu mới", context);
                      }else{
                          UpdatePassword();
                      }
                    },
